...
import report.restaurant.menu.Menu;
	...
	public double maxAlc() {return menu[0].getMaxAlc();}
	public int maxFull() {return menu[0].getMaxFull();}
	public int fullCheck(int custumerId) {return custumer[custumerId].getSatiety();}
	public double drunkCheck(int custumerId) {return custumer[custumerId].getDrunken();}
	public int menuStockCheck(int menuNumber) {return menu[menuNumber].getStock();}
	public int custumerMoney(int custumerId) {return custumer[custumerId].getMoney();}
	public int MenuPrice(int menuNumber) {return menu[menuNumber].getPrice();}
	public void totalSell() {System.out.println("총 매출액 : "+totalSales);}
	public double menuAlc(int menuNumber) {return menu[menuNumber].getAlc();}
	...
	public void custurmerOrder(int custumerId,int menuNumber) {;	
